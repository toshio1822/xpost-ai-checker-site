...
<!-- NAV-CHAIN:START -->
前回：[◀ 「Twitter魚拓」と「XPost AI Checker」の違い｜AIでまとめて判定・証拠化する新しい選択肢](001_twitter-gyotaku-vs-ai-checker.md) | [シリーズトップに戻る](_index.md) | 次回：[Wayback MachineでX（Twitter）投稿を保存できない理由と対処法【実証付き】 ▶](003_wayback-machine-x-fail.md)
<!-- NAV-CHAIN:END -->
