...
<!-- NAV-CHAIN:START -->
前回：[◀ XPost AI Checker使い方ガイド｜AIがSNS投稿を自動で分析し証拠PDFを作るまでの流れ](003_xpost-ai-checker-how-to-use.md) | [シリーズトップに戻る](_index.md) | 次回：[SNS投稿を「証拠として残す」には？スクショだけでは足りない理由を技術的に解説 ▶](005_sns-proof-technical.md)
<!-- NAV-CHAIN:END -->
